...
const notifTypeIcons = {
    JOIN_REQUEST_SUBMITTED: { icon: 'person_add', iconColor: 'text-blue-500 bg-blue-100 dark:bg-blue-900/40' },
    POINT_REQUEST_SUBMITTED: { icon: 'grade', iconColor: 'text-orange-500 bg-orange-100 dark:bg-orange-900/40' },
    EVIDENCE_SUBMITTED: { icon: 'upload_file', iconColor: 'text-purple-500 bg-purple-100 dark:bg-purple-900/40' },
    STUDENT_CHECKED_IN: { icon: 'fact_check', iconColor: 'text-green-500 bg-green-100 dark:bg-green-900/40' },
    DASHBOARD_UPDATED: { icon: 'dashboard', iconColor: 'text-indigo-500 bg-indigo-100 dark:bg-indigo-900/40' },
}
                ...
                <div className="relative" ref={notifRef}>
                    ...
                    {showNotifications && (
                        <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
                            ...
                            <div className="max-h-80 overflow-y-auto">
                                {notifLoading ? (
                                    <div className="flex items-center justify-center py-6"><div className="w-5 h-5 border-2 border-blue-500/30 border-t-blue-500 rounded-full animate-spin" /></div>
